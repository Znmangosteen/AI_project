...
class AI(object):
    ...
    def go(self, chessboard):
        ...
        best_value = 0
        best_point = []
        # total_value = np.zeros((self.chessboard_size, self.chessboard_size), dtype=np.int)

        for p in idx:
            total_value = 0
            current_value = self.getValueAt(chessboard, p, self.color)
            # total_value[p[0], p[1]] += current_value
    ...
    def getValueAt(self, chessboard, point, current_color):
        ...
        for dir in range(4):
            ...
            if count >= 5:
                ...
                elif left == COLOR_NONE and left_2 == COLOR_NONE and left_3 == COLOR_NONE and left_4 == COLOR_NONE and right == -current_color:
                    type['death1'] += 1
                elif right == COLOR_NONE and right_2 == COLOR_NONE and right_3 == COLOR_NONE and right_4 == COLOR_NONE and left == -current_color:
                    type['death1'] += 1
